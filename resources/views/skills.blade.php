<section class="resume-section p-3 p-lg-5 d-flex flex-column" id="skills">
    <div class="my-auto">
        ...
        <ul class="list-inline list-icons">
            ...
            <li class="list-inline-item">
                <i class="devicons devicons-database" data-toggle="tooltip" title="Database Design"></i>
            </li>
        </ul>
        ...
        <ul class="fa-ul mb-0">
            ...
            <li>
                <i class="fa-li fa fa-check"></i>
                Proficient with drafting in <strong>AutoCAD</strong> and <strong>SolidWorks</strong>
            </li>
            <li>
                <i class="fa-li fa fa-check"></i>
                Skilled in <strong>MATLAB</strong>, <strong>GIMP</strong>, and <strong>Microsoft Office</strong>
            </li>
        </ul>
    </div>
</section>